...
def publish_file(sck):
    try:
        ...
        if len(parts) >= 2:
            ...
            cursor.execute("INSERT INTO TranDau (lname, fname) values(?,?);",(lname,fname))
            cursor.commit()
