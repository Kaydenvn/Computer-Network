...
class StartPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label_title = tk.Label(
            self, text="LOG IN", font=LARGE_FONT, fg="#20639b", bg="bisque2"
        )
        label_user = tk.Label(
            self, text="username ", fg="#20639b", bg="bisque2", font="verdana 10 "
        )
        label_pswd = tk.Label(
            self, text="password ", fg="#20639b", bg="bisque2", font="verdana 10 "
        )
        ...
        button_log = tk.Button(
            ...
            bg="#20639b",
            fg="floral white",
            command=lambda: controller.logIn(self, client),
        )
        ...
        button_sign = tk.Button(
            ...
            bg="#20639b",
            fg="floral white",
            command=lambda: controller.signUp(self, client),
        )
...
class HomePage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label_title = tk.Label(
            self, text="HOME PAGE", font=LARGE_FONT, fg="#20639b", bg="bisque2"
        )
        button_back = tk.Button(
            ...
            bg="#20639b",
            fg="#f5ea54",
            command=lambda: controller.logout(self, client),
        )
        button_list = tk.Button(
            self, text="List all", bg="#20639b", fg="#f5ea54", command=self.listAll
        )
        ...
        self.label_score = tk.Label(
            self.frame_detail, bg="steelblue1", text="", font=LARGE_FONT
        )
...
class AdminPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.button_list = tk.Button(
            ...
            bg="#20639b",
            fg="#f5ea54",
            command=self.Insert_New_Match,
        )

        self.label_option = tk.Label(
            self, text="OPTION\t", fg="#20639b", bg="bisque2", font="verdana 15 bold"
        ).grid(row=1, column=0)
        self.label_notice = tk.Label(self, text="", bg="bisque2")
        ...
        self.option = ttk.Combobox(
            self, width=25, textvariable=self.n, font="Helvetica 13 "
        )
        self.option["values"] = (
            "Insert a match",
            "Update Score",
